...
#  this decorator marks the function as a Celery task
#  the name parameter is the name of the task
#  the task will be registered with the name upload_avatar_to_cloudinary
